#ifndef CORE_DEFORMED_INCLUDED
#define CORE_DEFORMED_INCLUDED

#include "UnityCG.cginc"
#include "UnityShaderVariables.cginc"
#include "UnityStandardConfig.cginc"
#include "InputDeformed.cginc"
...
VertexOutputForwardBase vertForwardBase (VertexInput v)
{
    ...
    half3 normalWorld = normalize(mul(UnityObjectToWorldNormal(v.normal), (float3x3)deformMatrix));
