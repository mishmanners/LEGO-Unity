#ifndef PARTICLES_DISTORTED_INCLUDED
#define PARTICLES_DISTORTED_INCLUDED
...
{
    // We do not support surface shader!
...
{
    // Modify texture coordinate.
    float uvOffset = noise(IN.pos.xyz * 2.0) - 0.5;
    IN.texcoord += float2(uvOffset, uvOffset) * 0.1;
    #if defined(_FLIPBOOK_BLENDING)
    IN.texcoord2AndBlend.xy += float2(uvOffset, uvOffset) * 0.1;
    #endif
...
#endif // PARTICLES_DISTORTED_INCLUDED