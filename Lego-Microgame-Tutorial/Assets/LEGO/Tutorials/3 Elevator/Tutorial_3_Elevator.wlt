...
MonoBehaviour:
  ...
  m_MinSize: {x: 0, y: 0}
  m_MaxSize: {x: 0, y: 0}
  m_LastLoadedLayoutName: Tutorial_3_Elevator
--- !u!114 &9
MonoBehaviour:
  m_ObjectHideFlags: 52
  m_CorrespondingSourceObject: {fileID: 0}
...
MonoBehaviour:
  ...
  m_LastProjectPath: C:\Projects\microgame-LEGO
  m_LockTracker:
    m_IsLocked: 0
  m_FolderTreeState:
    scrollPos: {x: 0, y: 212}
    m_SelectedIDs: 58f30100
    m_LastClickedID: 127832
    m_ExpandedIDs: 00000000d47b0000fcf00100fef0010000f1010002f1010004f1010006f1010008f10100f2f2010000ca9a3b
    m_RenameOverlay:
  ...
  m_AssetTreeState:
    ...
    m_SelectedIDs: 
    m_LastClickedID: 0
    m_ExpandedIDs: 00000000d47b0000fcf00100fef0010000f1010002f1010004f1010006f1010008f1010000ca9a3b
    m_RenameOverlay:
      m_UserAcceptedRename: 0
      m_Name: 
      m_OriginalName: 
    ...
    m_CreateAssetUtility:
      ...
      m_ResourceFile: 
  m_ListAreaState:
    m_SelectedInstanceIDs: e0480000
    m_LastClickedInstanceID: 18656
...
MonoBehaviour:
  ...
  m_SceneHierarchy:
    m_TreeViewState:
      scrollPos: {x: 0, y: 0}
      m_SelectedIDs: e0480000
      m_LastClickedID: 0
      m_ExpandedIDs: 5448d7ff284be7ff1cf1f9ff1220feffd0fbffff
      m_RenameOverlay:
        m_UserAcceptedRename: 0
        m_Name: 
        m_OriginalName: 
...
MonoBehaviour:
  ...
  m_AudioPlay: 0
  m_Position:
    m_Target: {x: 210.4173, y: 20.396633, z: -122.23787}
    speed: 2
    m_Value: {x: 217.53523, y: 10.422757, z: -125.062256}
  m_RenderMode: 0
  m_CameraMode:
    drawMode: 0
    name: Shaded
  ...
  m_Grid:
    ...
    m_gridOpacity: 0.5
  m_Rotation:
    m_Target: {x: -0.046649143, y: 0.7983068, z: 0.062294804, w: 0.59722364}
    speed: 2
    m_Value: {x: 0.23547582, y: 0.660901, z: -0.23092222, w: 0.67413706}
  m_Size:
    m_Target: 8.442031
    speed: 2
    m_Value: 37.45998
...
MonoBehaviour:
  ...
  m_ZoomArea:
    ...
    m_HBaseRangeMin: -410
    m_HBaseRangeMax: 410
    m_VBaseRangeMin: -230.66667
    m_VBaseRangeMax: 230.66667
    ...
    m_MinimalGUI: 1
  m_defaultScale: 1
  m_LastWindowPixelSize: {x: 1845, y: 1230}
  m_ClearInEditMode: 1
  m_NoCameraWarning: 1
